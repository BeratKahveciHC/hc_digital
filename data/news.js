...
export const news = [
  {
    ...
    title: {
      tr: 'HC Dijital, Bilişim Vadisi Vizyonuyla Sağlık Teknolojilerinde Yeni Döneme Odaklanıyor',
      en: 'HC Dijital Focuses on a New Era in Health Technologies with the Bilişim Vadisi Vision',
    },
    summary: {
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'Lisanslanan patentler arasında HC Dijital Sağlık Teknolojileri de yer almakta olup, bu sürecin arkasında Kurucumuz Ersan BİÇKİOĞLU\'nun vizyonu, yönlendirmesi ve teknoloji odaklı yaklaşımı bulunmaktadır. Akademik üretimin yalnızca teorik düzeyde kalmayıp, ticarileştirilebilir ve uygulanabilir çözümlere dönüşmesi noktasında ortaya koyduğu liderlik ve vizyon bu başarının temel belirleyicisi olmuştur.',
        'Kurucumuz Ersan BİÇKİOĞLU\'nun özellikle sağlık sektöründe veri odaklı sistemler, yapay zekâ uygulamaları ve karar destek mekanizmalarına yaptığı yatırımlar, geliştirilen teknolojilerin sahada karşılık bulmasını ve patent düzeyinde değer üretmesini mümkün kılmıştır.',
      ...
      en: [
        ...
        'HC Dijital Health Technologies is among the companies receiving licensed patents, and behind this process lies the vision, guidance, and technology-focused approach of our Founder Ersan BİÇKİOĞLU. His leadership and vision in ensuring that academic output does not remain merely theoretical but transforms into commercializable and applicable solutions has been the key determinant of this success.',
        'The investments made by our Founder Ersan BİÇKİOĞLU — particularly in data-driven systems, AI applications, and decision support mechanisms in the healthcare sector — have made it possible for the developed technologies to find real-world application and generate value at the patent level.',
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'HC Dijital Sağlık Teknolojileri olarak bu önemli açılışta yer aldık. Kurucumuz Ersan BİÇKİOĞLU liderliğinde, sağlık sektöründe veri odaklı karar destek sistemleri, yapay zekâ ve dijital altyapı çözümleri geliştirerek kurumların operasyonel verimliliğini artırırken sürdürülebilirlik hedeflerine somut katkı sağlıyoruz.',
      ...
      en: [
        ...
        'As HC Dijital Health Technologies, we were present at this important opening. Under the leadership of our founder Ersan BİÇKİOĞLU, we develop data-driven decision support systems, AI, and digital infrastructure solutions in the healthcare sector — contributing concretely to sustainability goals while increasing the operational efficiency of institutions.',
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'HC Dijital Sağlık Teknolojileri çatısı altında geliştirilen TercüMed, dijitalleşme ve operasyonel verimlilik odağında sunduğu çözümlerle öne çıkıyor. Projenin bu seviyeye ulaşmasında ise Kurucumuz Ersan BİÇKİOĞLU\'nun yönlendirmesi, stratejik bakış açısı ve teknolojiye dayalı yaklaşımı belirleyici oldu.',
        'Ersan BİÇKİOĞLU\'nun özellikle doğru problemi tanımlama, çözümün mimarisini kurma ve ticarileşmeye yönelik vizyonu konusunda sergilediği liderlik, TercüMed\'in değerlendirmede maksimum skora ulaşmasının en önemli unsurlarından biri olarak dikkat çekiyor.',
      ...
      en: [
        ...
        { type: 'image', src: kosgeb, alt: 'KOSGEB', fit: 'contain' },
        'TercüMed, developed under the HC Dijital Health Technologies umbrella, stands out with the solutions it offers focused on digitalization and operational efficiency. The guidance, strategic perspective, and technology-driven approach of our Founder Ersan BİÇKİOĞLU played a decisive role in the project reaching this level.',
        'The leadership demonstrated by Ersan BİÇKİOĞLU — particularly in defining the right problem, building the solution architecture, and his vision for commercialization — stands out as one of the most important factors in TercüMed achieving the maximum score in the evaluation.',
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'Kurucumuz Ersan BİÇKİOĞLU, AiRX\'in sadece bir PDKS çözümü olmadığını; kurumların iş gücü yönetimini uçtan uca dijitalleştiren bir platform sunduğunu ifade etti. Ayrıca veri odaklı karar alma süreçlerini güçlendirmeyi hedeflediklerini belirtti.',
      ...
      en: [
        ...
        'Our Founder Ersan BİÇKİOĞLU stated that AiRX is not just a time-and-attendance solution, but a platform that end-to-end digitalizes workforce management for institutions. He also noted that they aim to strengthen data-driven decision-making processes.',
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'Kurucumuz Ersan BİÇKİOĞLU, bütçe yönetiminin sağlık sektöründe stratejik kararların şekillenmesinde kritik bir noktada durduğunu ifade etti. Geliştirdikleri sistem sayesinde kurumların kısa vadeli operasyonlarını ve uzun vadeli finansal hedeflerini daha kontrollü ve sağlıklı biçimde yönetebileceğini söyledi.',
      ...
      en: [
        ...
        'Our Founder Ersan BİÇKİOĞLU stated that budget management stands at a critical juncture in shaping strategic decisions in the healthcare sector. He noted that through the system they developed, institutions will be able to manage their short-term operations and long-term financial goals in a more controlled and healthy manner.',
  ...
  },
  {
    ...
    content: {
      tr: [
        ...
        'Kurucumuz Ersan BİÇKİOĞLU, bu sürecin şirket için önemli bir eşik olduğuna dikkat çekerek, "Milli Teknoloji Hamlesi vizyonuyla uyumlu biçimde, sağlık sektöründe dijital dönüşümü hızlandırmaya yardımcı olacak çözümler geliştirmeyi sürdürüyoruz. Bilişim Vadisi\'nde yer almak ve Teknogirişim rozeti almak, doğru yönde ilerlediğimizi ortaya koyuyor." dedi.',
      ...
      en: [
        ...
        'Our Founder Ersan BİÇKİOĞLU, noting that this process represents an important threshold for the company, stated: "In line with the National Technology Initiative vision, we continue to develop solutions that will help accelerate digital transformation in the healthcare sector. Being part of Bilişim Vadisi and receiving the Technoenterprise badge demonstrates that we are moving in the right direction."',
