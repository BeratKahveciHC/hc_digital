...
import VeriAnalitigiPage from '../pages_services/VeriAnalitigiPage'
import YazilimGelistirmePage from '../pages_services/YazilimGelistirmePage'
import YapayZekaPage from '../pages_services/YapayZekaPage'
import RaporlamaSistemleriPage from '../pages_services/RaporlamaSistemleriPage'
import TeknolojDanismanligiPage from '../pages_services/TeknolojDanismanligiPage'
import VeriBilimiPage from '../pages_services/VeriBilimiPage'
...
export default function ServiceDetailPage() {
  ...
  if (!exists) { if (typeof window !== 'undefined') router.replace('/servisler'); return null }

  const PageComponent = pageMap[slug]
  if (!PageComponent) { if (typeof window !== 'undefined') router.replace('/servisler'); return null }
