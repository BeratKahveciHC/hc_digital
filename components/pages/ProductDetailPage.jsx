...
import AirxIkysPage from '../pages_products/AirxIkysPage'
import TercumedPage from '../pages_products/TercumedPage'
import KumandaMerkeziPage from '../pages_products/KumandaMerkeziPage'
import YonAssistPage from '../pages_products/YonAssistPage'
import ButceYonetimPage from '../pages_products/ButceYonetimPage'
import SpiralFreezerPage from '../pages_products/SpiralFreezerPage'
...
export default function ProductDetailPage() {
  ...
  if (!product) { if (typeof window !== 'undefined') router.replace('/urunler'); return null }

  const PageComponent = pageMap[slug]
  if (!PageComponent) { if (typeof window !== 'undefined') router.replace('/urunler'); return null }
