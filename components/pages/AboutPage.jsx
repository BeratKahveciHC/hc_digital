      ...
      <section className="py-24 md:py-32 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <motion.div {...fadeUpView()} className="mb-20">
            <div className="flex items-center gap-3 mb-4">
              <div style={{ height: '1px', width: '24px', background: 'linear-gradient(to right, #1b5fc1, #4EA8FF)' }} />
              <span style={{ fontFamily:"'Albert Sans',sans-serif", fontSize:'1rem', fontWeight:600, letterSpacing:'0.18em', textTransform:'uppercase', background:'linear-gradient(to right,#1b5fc1,#4EA8FF)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>{lang === 'en' ? 'Our Team' : 'Ekibimiz'}</span>
            </div>
          ...
          <div className="flex justify-center mb-5">
            {[{ name: 'Ersan Biçkioğlu', role: 'Kurucu / Founder', img: ersanBickioglu }].map((p, i) => (
          ...
          {/* Sıra 2 — Hasan */}
          <div className="flex justify-center mb-5">
            {[{ name: 'Dr. Hasan Oğuz', role: 'Danışman / Advisor', img: hasanOguz }].map((p, i) => (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {[
              { name: 'Batuhan Küçükkısa', role: 'Yazılım Geliştirme Uzmanı / Full Stack Developer', img: batuhanKucukkisa },
              { name: 'Deniz Yetim',       role: 'Yazılım Geliştirme Uzmanı / Full Stack Developer', img: denizYetim },
              { name: 'Zeren Korkmaz',     role: 'Yazılım Geliştirme Uzmanı / Artificial Intelligence Developer',          img: zerenKorkmaz },
              { name: 'Berat Kaan Seven',  role: 'Ürün ve Proje Müdürü / Product Manager',           img: beratKaanSeven },
              { name: 'Berat Kahveci',     role: 'Yazılım Geliştirme Uzmanı / Full Stack Developer', img: beratKahveci },
            ].map((p, i) => (
