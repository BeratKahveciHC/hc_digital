...
const team = [
  // Kurucu
  {
    row: 'founder',
    members: [
      { name: 'Ersan Biçkioğlu', role: { tr: 'Kurucu', en: 'Founder' }, img: ersanBickioglu },
    ],
  },
  // Danışman
  {
    row: 'advisor',
    members: [
      { name: 'Dr. Hasan Oğuz', role: { tr: 'Danışman', en: 'Advisor' }, img: hasanOguz },
    ],
  },
  // Ekip
  {
    row: 'team',
    members: [
      { name: 'Batuhan Küçükkısa', role: { tr: 'Yazılım Geliştirme Uzmanı', en: 'Full Stack Developer' },                 img: batuhanKucukkisa },
      { name: 'Deniz Yetim',       role: { tr: 'Yazılım Geliştirme Uzmanı', en: 'Full Stack Developer' },                 img: denizYetim },
      { name: 'Zeren Korkmaz',     role: { tr: 'Yazılım Geliştirme Uzmanı', en: 'Artificial Intelligence Developer' },    img: zerenKorkmaz },
      { name: 'Berat Kaan Seven',  role: { tr: 'Ürün ve Proje Müdürü',      en: 'Product Manager' },                      img: beratKaanSeven },
      { name: 'Berat Kahveci',     role: { tr: 'Yazılım Geliştirme Uzmanı', en: 'Full Stack Developer' },                 img: beratKahveci },
    ],
  },
]
