...
export default function ServicesPage() {
  ...
  return (
    <div className="bg-white text-dark">
      <SEO
        title={lang === 'tr' ? 'Hizmetlerimiz | HC Dijital' : 'Our Services | HC Digital'}
        description={lang === 'tr'
          ? 'HC Dijital hizmetleri: Yazılım geliştirme, yapay zeka, veri analitiği, raporlama sistemleri ve teknoloji danışmanlığı.'
          : 'HC Digital services: Software development, AI, data analytics, reporting systems and technology consulting.'}
        canonical="/servisler"
        lang={lang}
      />
      <Header />
