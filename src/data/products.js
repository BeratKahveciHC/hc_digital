export const products = [
  {
    ...
    features: [
      { number: '01', title: 'Kolay Kurulum ve Hızlı Kullanım', description: 'Teknik altyapı gerektirmeyen kurulum süreci sayesinde ekibiniz aynı gün sistemi kullanmaya başlar. Sezgisel arayüz, eğitim süresini minimize eder.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80' },
      { number: '02', title: 'Mobil & Web Üzerinden Erişim', description: 'Çalışanlar giriş-çıkış kaydı, izin talebi ve vardiya bilgilerine her cihazdan ulaşır. Yöneticiler anlık durumu web panelinden veya mobil uygulamadan takip eder.', image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=80' },
      { number: '03', title: 'Düzenli Raporlar ve Dışa Aktarma', description: 'Devam, devamsızlık, mesai ve izin verileri otomatik olarak raporlanır. Excel ve PDF formatında dışa aktarılarak bordro ve denetim süreçlerine doğrudan entegre edilir.', image: 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=1200&q=80' },
    ],
    featured: true,
    ...
    en: {
      ...
      features: [
        { number: '01', title: 'Easy Setup & Fast Onboarding', description: 'Cloud-based setup requires no technical infrastructure. Your team can start using the platform the same day with an intuitive interface that minimizes training time.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80' },
        { number: '02', title: 'Mobile & Web Access', description: 'Employees access check-in records, leave requests, and shift information from any device. Managers monitor real-time status from the web panel or mobile app.', image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&q=80' },
        { number: '03', title: 'Automated Reports & Data Export', description: 'Attendance, absence, overtime, and leave data are automatically reported. Excel and PDF exports integrate directly with payroll and audit processes.', image: 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=1200&q=80' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    features: [
      { number: '01', title: 'Tıbbi Terminolojiye Duyarlı Çeviri', description: 'Genel amaçlı çeviri araçlarının aksine Tercümed, tıbbi terminoloji üzerinde özel olarak eğitilmiştir. Tanı, ilaç adları ve klinik prosedür terimleri yüksek doğrulukla çevrilir.', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&q=80' },
      { number: '02', title: 'PDF ve Word Çıktı Seçenekleri', description: 'Çevrilen belgeler PDF veya Word formatında indirilebilir. Orijinal belge düzeni korunarak çıktı doğrudan hasta dosyasına eklenmeye hazır hâle gelir.', image: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=1200&q=80' },
      { number: '03', title: 'Üç Adımda Tamamlanan Süreç', description: 'Dosyayı yükle, hedef dili seç, çevrilmiş çıktıyı indir. Karmaşık kurulum ya da eğitim gerektirmez; hasta kabul biriminden klinisyene kadar herkes anında kullanabilir.', image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&q=80' },
    ],
    featured: false,
    ...
    en: {
      ...
      features: [
        { number: '01', title: 'Medically-Aware Translation', description: 'Unlike general-purpose tools, Tercümed is specially trained on medical terminology. Diagnoses, drug names, and clinical procedure terms are translated with high accuracy.', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&q=80' },
        { number: '02', title: 'PDF and Word Output Options', description: 'Translated documents can be downloaded in PDF or Word format. Output is ready to be added directly to patient files with original layout preserved.', image: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=1200&q=80' },
        { number: '03', title: 'Three-Step Process', description: 'Upload the file, select the target language, download the translated output. No complex setup required — usable instantly by anyone from patient admission to clinician.', image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&q=80' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    features: [
      { number: '01', title: 'Gerçek Zamanlı Veri Akışı', description: 'Tüm sistemlerden akan veriler anlık olarak işlenir ve tek panelde görselleştirilir. Gecikme olmaksızın güncel operasyonel tablo her an yöneticinin önündedir.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80' },
      { number: '02', title: 'Alarm Yönetimi', description: 'Kritik eşiklerin aşılması durumunda ilgili ekipler SMS, e-posta veya uygulama bildirimi alır. Alarm önceliklendirme yapısı, gereksiz uyarı gürültüsünü filtreler.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80' },
      { number: '03', title: 'Kapsamlı Raporlama', description: 'Anlık durum raporlarının yanı sıra geçmişe dönük karşılaştırmalı analizler üretilir. SLA takibi ve kapasite planlaması için ihtiyaç duyulan tüm veriler tek çatı altında toplanır.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80' },
    ],
    featured: false,
    ...
    en: {
      ...
      features: [
        { number: '01', title: 'Real-Time Data Flow', description: 'Data flowing from all systems is processed instantly and visualized in a single panel. The current operational picture is always in front of the manager without delay.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80' },
        { number: '02', title: 'Alarm Management', description: 'When critical thresholds are exceeded, relevant teams receive SMS, email, or app notifications. The alarm prioritization structure filters unnecessary alert noise.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80' },
        { number: '03', title: 'Comprehensive Reporting', description: 'In addition to real-time status reports, retrospective comparative analyses are generated. All data needed for SLA tracking and capacity planning is collected under one roof.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    longDescription: [
      ...
      'Çok sektörlü kullanım imkânı sunan platform, 7/24 erişilebilirlik ve yüksek veri güvenliğiyle üst düzey bir dijital asistan deneyimi sağlar. Sağlık kurumlarından kurumsal işletmelere kadar geniş bir kullanıcı kitlesine hitap eder.',
    ...
    benefits: [
      { icon: 'Zap', title: 'Anında Yanıt', description: 'Sesli veya yazılı komutlara milisaniyeler içinde yanıt verir; doğal dil sözdizimi öğrenmeye gerek yok.' },
    ...
    faqs: [
      ...
      { question: 'Transkript doğruluğu nasıl?', answer: 'Standart Türkçe konuşma için %92 üzeri doğruluk oranı elde edilmektedir. Sektöre özel terim sözlükleri ek iyileştirme sağlar.' },
      { question: 'Veri nerede saklanıyor?', answer: 'Türkiye lokasyonlu sunucularda, KVKK gerekliliklerine tam uyumlu şekilde saklanmaktadır. Kurumsal taleplerde yerinde kurulum da mümkündür.' },
    ],
    ...
    features: [
      { number: '01', title: 'Sesli ve Yazılı Komut Anlama', description: 'NLP altyapısı sayesinde hem sesli hem yazılı komutları doğal dilde algılar. "Yarın saat 10\'da toplantı ayarla" gibi günlük ifadeler anında işleme alınır.', image: 'https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=1200&q=80' },
      { number: '02', title: 'Toplantı Özetleri ve Görev Yönetimi', description: 'Toplantılar otomatik olarak transkribe edilir, eylem maddeleri tespit edilir ve ilgili kişilere görev olarak atanır. Manuel not alma ihtiyacı ortadan kalkar.', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1200&q=80' },
      { number: '03', title: '7/24 Erişilebilirlik ve Yüksek Güvenlik', description: 'Platform kesintisiz çalışır ve tüm veri işlemleri yüksek güvenlik standartları kapsamında yürütülür. Çok sektörlü kullanıma uygun esnek altyapısıyla her ölçekte kuruma entegre edilebilir.', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&q=80' },
    ],
    featured: false,
    color: 'bg-accent/8 text-accent-dark border-accent/15',
    dot: 'bg-accent',
    en: {
      ...
      longDescription: [
        ...
        'The multi-sector platform provides a premium digital assistant experience with 24/7 accessibility and high data security, serving a wide user base from healthcare institutions to corporate businesses.',
      ...
      benefits: [
        { icon: 'Zap', title: 'Instant Response', description: 'Responds to voice or text commands in milliseconds; no special syntax needed.' },
      ...
      features: [
        { number: '01', title: 'Voice and Text Command Understanding', description: 'Detects both voice and text commands in natural language through NLP. Everyday expressions like "Schedule a meeting tomorrow at 10" are instantly processed.', image: 'https://images.unsplash.com/photo-1591115765373-5207764f72e7?w=1200&q=80' },
        { number: '02', title: 'Meeting Summaries and Task Management', description: 'Meetings are automatically transcribed, action items are identified, and assigned as tasks to relevant people. The need for manual note-taking is eliminated.', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1200&q=80' },
        { number: '03', title: '24/7 Accessibility and High Security', description: 'The platform operates continuously and all data operations are conducted under high security standards. Integrable with any scale of organization through its flexible, multi-sector infrastructure.', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&q=80' },
      ],
      howItWorks: [
      ...
      faqs: [
        ...
        { question: 'How accurate is the transcription?', answer: 'Accuracy rate above 92% is achieved for standard Turkish speech. Industry-specific terminology dictionaries provide additional improvement.' },
        { question: 'Where is data stored?', answer: 'Stored on Turkey-based servers, fully compliant with local data protection requirements. On-premise installation is also possible for enterprise requests.' },
      ],
    },
  },
  {
    ...
    longDescription: [
      'Hastane Bütçe Yönetim Sistemi, ekip yönetimi ve iş süreçlerini tek kontrol panelinde birleştirir. Otomatik gider–gelir takibi, gerçek zamanlı öngörüler ve yapay zekâ destekli raporlarla yalnızca sayıları izlemenin ötesinde stratejik kararlar almanızı sağlar.',
      'Ölçeklenebilir ve güvenli altyapısıyla küçük kliniklerden büyük hastane zincirlerine kadar her ölçekte kuruma uyum sağlar. Mevcut ERP ve HBYS sistemleriyle entegre çalışarak veri silolarını ortadan kaldırır.',
      'Bütçe aşımları oluşmadan önce yapay zekâ tabanlı uyarı mekanizması devreye girer. Yönetim kurulu raporları ve birim bazlı maliyet analizleri tek tıkla hazır hâle gelir.',
    ],
    stats: [
    ...
    faqs: [
      { question: 'Hangi ERP sistemleriyle entegre olur?', answer: 'SAP, Oracle ve yerli HBYS çözümleriyle entegrasyon desteklenmektedir. Özel entegrasyon talepleri için teknik ekibimiz çözüm üretir.' },
      ...
      { question: 'Yapay zekâ tahminleri ne kadar güvenilir?', answer: 'Model, kurumunuzun geçmiş 12-24 aylık verisini analiz ederek sapma tahminleri üretir. Ortalama hata payı %5\'in altındadır.' },
    ...
    features: [
      { number: '01', title: 'Otomatik Gider–Gelir Takibi', description: 'Tüm gelir ve gider kalemleri otomatik olarak sınıflandırılır ve izlenir. Manuel veri girişi ihtiyacı ortadan kalkar; muhasebe süreçleri hata payı sıfıra yaklaşır.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80' },
      { number: '02', title: 'Yapay Zekâ Destekli Raporlar', description: 'Geçmiş verileri analiz eden yapay zekâ motoru, gelecek dönem bütçe tahminleri ve sapma uyarıları üretir. Yöneticiler öngörülü kararlar alarak maliyetleri optimize eder.', image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=1200&q=80' },
      { number: '03', title: 'Ölçeklenebilir ve Güvenli Altyapı', description: 'Bulut tabanlı güvenli altyapı, kurumunuzun büyümesiyle birlikte ölçeklenir. Rol bazlı erişim kontrolü ve veri şifreleme ile hassas finansal veriler her zaman korunaklıdır.', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80' },
    ],
    featured: false,
    color: 'bg-primary/8 text-primary border-primary/15',
    dot: 'bg-primary',
    en: {
      ...
      longDescription: [
        'The Hospital Budget Management System consolidates team management and business processes in a single control panel. With automated expense-income tracking, real-time insights, and AI-powered reports, it enables strategic decisions beyond just monitoring numbers.',
        'With its scalable and secure infrastructure, it adapts to any size institution from small clinics to large hospital chains. Working integrated with existing ERP and HIS systems, it eliminates data silos.',
        'The AI-based warning mechanism activates before budget overruns occur. Board reports and unit-based cost analyses are instantly ready with a single click.',
      ],
      ...
      features: [
        { number: '01', title: 'Automated Expense-Income Tracking', description: 'All revenue and expense items are automatically classified and monitored. The need for manual data entry is eliminated; accounting processes approach zero margin of error.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80' },
        { number: '02', title: 'AI-Powered Reports', description: 'The AI engine analyzing historical data generates future period budget forecasts and deviation warnings. Managers make proactive decisions to optimize costs.', image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=1200&q=80' },
        { number: '03', title: 'Scalable and Secure Infrastructure', description: 'The cloud-based secure infrastructure scales with your organization\'s growth. Role-based access control and data encryption keep sensitive financial data always protected.', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&q=80' },
      ],
      howItWorks: [
      ...
      faqs: [
        { question: 'Which ERP systems does it integrate with?', answer: 'Integration with SAP, Oracle, and local HIS solutions is supported. Our technical team provides solutions for custom integration requests.' },
        ...
        { question: 'How reliable are the AI forecasts?', answer: 'The model analyzes your organization\'s past 12-24 months of data to generate deviation forecasts. The average margin of error is below 5%.' },
        { question: 'Does my accounting team need additional training?', answer: 'Basic training is completed in 2 hours thanks to the intuitive interface design. On-site training and online support are standard.' },
      ],
    },
  },
  {
    ...
    longDescription: [
      ...
      "AISI 304 paslanmaz çelik gövde ve ürün temas yüzeyleri, yoğun üretim koşullarında dayanıklılığı sürdürürken hijyen standartlarını en üst seviyede tutar. Entegre CIP (Clean-in-Place) sistemi temizlik sürelerini kısaltır ve operasyonel kesinti riskini azaltır.",
      "Patentli hava akışı teknolojisi sayesinde enerji tüketimi %30'a kadar azalır. Modüler tasarım yapısı, mevcut ekipmanı sökmeden kapasite artışına olanak tanır; yeni spiral katmanlar veya bant modülleri eklenerek kapasite dakikalar içinde ikiye katlanabilir.",
    ],
    stats: [
    ...
    benefits: [
      ...
      { icon: 'TrendingUp', title: 'Enerji Verimliliği', description: 'Patentli hava akışı teknolojisi enerji tüketimini %30\'a kadar azaltır; işletme maliyetleri düşer.' },
      ...
      { icon: 'Plug', title: 'Modüler Büyüme', description: 'Kapasite artışı için mevcut sistemi sökmek gerekmez; yeni modüller eklenerek büyüme sağlanır.' },
      ...
      { icon: 'Headphones', title: '7/24 Teknik Destek', description: '20+ yıllık deneyimli ekip, sahadaki her sorunu hızla çözer; kesintisiz çalışma garantisi.' },
    ],
    howItWorks: [
      ...
      { step: 3, title: 'Kurulum ve Devreye Alma', description: 'Uzman ekibimiz sahada kurulum ve entegrasyonu gerçekleştirir; SAT testi yapılır.' },
    ...
    faqs: [
      ...
      { question: 'Minimum kapasite ne kadardır?', answer: 'Modüler yapı sayesinde günlük 500 kg\'dan tonlarca kapasiteye kadar yapılandırma mümkündür. Projeye özel boyutlandırma yapılır.' },
      ...
      { question: 'Bakım ne sıklıkla yapılmalı?', answer: 'Standart bakım periyodu 6 ayda birdir. Uzaktan izleme sistemi, arıza öncesinde bakım uyarısı üreterek plansız duruşları minimize eder.' },
    ],
    ...
    features: [
      { number: '01', title: 'Patentli Hava Akışı Teknolojisi', description: "Kabinde ideal ve homojen hava geçişi oluşturan özel bant tipleriyle konveyör taşıma sistemi, ısı transferini hızlandırır. Gelişmiş yalıtım panelleriyle enerji tüketimi %30'a kadar azalır.", image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&q=80' },
      { number: '02', title: 'Modüler Tasarım', description: 'Projeye özel modüller kapasite ayarlamasına izin verir. Mevcut ekipmanı sökmeden yeni spiral katmanlar veya bant modülleri eklenerek kapasite dakikalar içinde ikiye katlanabilir.', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&q=80' },
      { number: '03', title: 'Entegre CIP Sistemi ve Sertifikasyon', description: "Clean-in-Place sistemi temizlik sürelerini kısaltır, 3-A SSA ve CE standartlarına tam uyumluluk sağlar. 20+ yıllık deneyim ve 7/24 teknik destekle sistemin kesintisiz çalışması garanti altındadır.", image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=1200&q=80' },
    ],
    featured: false,
    color: 'bg-sky/8 text-sky border-sky/15',
    dot: 'bg-sky',
    en: {
      ...
      longDescription: [
        ...
        'AISI 304 stainless steel body and product contact surfaces maintain durability under intense production conditions while keeping hygiene standards at the highest level. The integrated CIP (Clean-in-Place) system shortens cleaning times and reduces the risk of operational downtime.',
        'Thanks to patented airflow technology, energy consumption is reduced by up to 30%. The modular design allows for capacity increases without disassembling existing equipment; new spiral layers or belt modules can be added to double capacity within minutes.',
      ],
      ...
      benefits: [
        ...
        { icon: 'TrendingUp', title: 'Energy Efficiency', description: 'Patented airflow technology reduces energy consumption by up to 30%; operating costs decrease.' },
        ...
        { icon: 'Plug', title: 'Modular Expansion', description: 'No need to disassemble existing system for capacity increase; add new modules to grow.' },
        ...
        { icon: 'Headphones', title: '24/7 Technical Support', description: 'Experienced team with 20+ years quickly resolves field issues; continuous operation guaranteed.' },
      ],
      features: [
        { number: '01', title: 'Patented Airflow Technology', description: 'The conveyor system with special belt types creating ideal homogeneous airflow in the cabinet accelerates heat transfer. Energy consumption is reduced by up to 30% with advanced insulation panels.', image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&q=80' },
        { number: '02', title: 'Modular Design', description: 'Project-specific modules allow capacity adjustment. New spiral layers or belt modules can be added without disassembling existing equipment, doubling capacity within minutes.', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&q=80' },
        { number: '03', title: 'Integrated CIP System & Certification', description: 'The Clean-in-Place system shortens cleaning times and ensures full compliance with 3-A SSA and CE standards. Uninterrupted operation is guaranteed with 20+ years of experience and 24/7 technical support.', image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=1200&q=80' },
      ],
      howItWorks: [
        ...
        { step: 3, title: 'Installation & Commissioning', description: 'Our expert team performs on-site installation and integration; SAT testing is conducted.' },
      ...
      faqs: [
        ...
        { question: 'What is the minimum capacity?', answer: 'Configuration from 500 kg per day to tons is possible thanks to the modular structure. Project-specific sizing is performed.' },
        ...
        { question: 'How often should maintenance be performed?', answer: 'Standard maintenance period is every 6 months. The remote monitoring system generates maintenance warnings before breakdowns to minimize unplanned downtime.' },
      ],
    },
  },
]
