export const products = [
  {
    ...
    gallery: [
      '/images/products/airx-hero.webp',
      '/images/products/airx-2.webp',
      '/images/products/airx-3.webp',
      '/images/products/airx-4.webp',
    ],
    features: [
      { number: '01', title: 'Kolay Kurulum ve Hızlı Kullanım', description: 'Teknik altyapı gerektirmeyen kurulum süreci sayesinde ekibiniz aynı gün sistemi kullanmaya başlar. Sezgisel arayüz, eğitim süresini minimize eder.', image: '/images/products/airx-setup.webp' },
      { number: '02', title: 'Mobil & Web Üzerinden Erişim', description: 'Çalışanlar giriş-çıkış kaydı, izin talebi ve vardiya bilgilerine her cihazdan ulaşır. Yöneticiler anlık durumu web panelinden veya mobil uygulamadan takip eder.', image: '/images/products/airx-mobile.webp' },
      { number: '03', title: 'Düzenli Raporlar ve Dışa Aktarma', description: 'Devam, devamsızlık, mesai ve izin verileri otomatik olarak raporlanır. Excel ve PDF formatında dışa aktarılarak bordro ve denetim süreçlerine doğrudan entegre edilir.', image: '/images/products/airx-report.webp' },
    ],
    featured: true,
  ...
  },
  {
    ...
    heroImage: '/images/products/tercumed-hero.webp',
    gallery: [
      '/images/products/tercumed-hero.webp',
      '/images/products/tercumed-2.webp',
      '/images/products/tercumed-3.webp',
      '/images/products/tercumed-4.webp',
    ],
    features: [
      { number: '01', title: 'Tıbbi Terminolojiye Duyarlı Çeviri', description: 'Genel amaçlı çeviri araçlarının aksine Tercümed, tıbbi terminoloji üzerinde özel olarak eğitilmiştir. Tanı, ilaç adları ve klinik prosedür terimleri yüksek doğrulukla çevrilir.', image: '/images/products/tercumed-terminology.webp' },
      { number: '02', title: 'PDF ve Word Çıktı Seçenekleri', description: 'Çevrilen belgeler PDF veya Word formatında indirilebilir. Orijinal belge düzeni korunarak çıktı doğrudan hasta dosyasına eklenmeye hazır hâle gelir.', image: '/images/products/tercumed-pdf.webp' },
      { number: '03', title: 'Üç Adımda Tamamlanan Süreç', description: 'Dosyayı yükle, hedef dili seç, çevrilmiş çıktıyı indir. Karmaşık kurulum ya da eğitim gerektirmez; hasta kabul biriminden klinisyene kadar herkes anında kullanabilir.', image: '/images/products/tercumed-steps.webp' },
    ],
    featured: false,
    ...
    en: {
      ...
      features: [
        { number: '01', title: 'Medically-Aware Translation', description: 'Unlike general-purpose tools, Tercümed is specially trained on medical terminology. Diagnoses, drug names, and clinical procedure terms are translated with high accuracy.', image: '/images/products/tercumed-terminology.webp' },
        { number: '02', title: 'PDF and Word Output Options', description: 'Translated documents can be downloaded in PDF or Word format. Output is ready to be added directly to patient files with original layout preserved.', image: '/images/products/tercumed-pdf.webp' },
        { number: '03', title: 'Three-Step Process', description: 'Upload the file, select the target language, download the translated output. No complex setup required — usable instantly by anyone from patient admission to clinician.', image: '/images/products/tercumed-steps.webp' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    gallery: [
      ...
      '/images/products/kumanda-2.webp',
      '/images/products/tercumed-steps.webp',
    ],
    features: [
      { number: '01', title: 'Gerçek Zamanlı Veri Akışı', description: 'Tüm sistemlerden akan veriler anlık olarak işlenir ve tek panelde görselleştirilir. Gecikme olmaksızın güncel operasyonel tablo her an yöneticinin önündedir.', image: '/images/products/kumanda-hero.webp' },
      { number: '02', title: 'Alarm Yönetimi', description: 'Kritik eşiklerin aşılması durumunda ilgili ekipler SMS, e-posta veya uygulama bildirimi alır. Alarm önceliklendirme yapısı, gereksiz uyarı gürültüsünü filtreler.', image: '/images/products/airx-setup.webp' },
      { number: '03', title: 'Kapsamlı Raporlama', description: 'Anlık durum raporlarının yanı sıra geçmişe dönük karşılaştırmalı analizler üretilir. SLA takibi ve kapasite planlaması için ihtiyaç duyulan tüm veriler tek çatı altında toplanır.', image: '/images/products/kumanda-2.webp' },
    ],
    featured: false,
    ...
    en: {
      ...
      features: [
        { number: '01', title: 'Real-Time Data Flow', description: 'Data flowing from all systems is processed instantly and visualized in a single panel. The current operational picture is always in front of the manager without delay.', image: '/images/products/kumanda-hero.webp' },
        { number: '02', title: 'Alarm Management', description: 'When critical thresholds are exceeded, relevant teams receive SMS, email, or app notifications. The alarm prioritization structure filters unnecessary alert noise.', image: '/images/products/airx-setup.webp' },
        { number: '03', title: 'Comprehensive Reporting', description: 'In addition to real-time status reports, retrospective comparative analyses are generated. All data needed for SLA tracking and capacity planning is collected under one roof.', image: '/images/products/kumanda-2.webp' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    heroImage: '/images/products/yon-hero.webp',
    gallery: [
      '/images/products/yon-hero.webp',
      '/images/products/yon-2.webp',
      '/images/products/yon-3.webp',
      '/images/products/yon-4.webp',
    ],
    features: [
      { number: '01', title: 'Sesli ve Yazılı Komut Anlama', description: 'NLP altyapısı sayesinde hem sesli hem yazılı komutları doğal dilde algılar. "Yarın saat 10\'da toplantı ayarla" gibi günlük ifadeler anında işleme alınır.', image: '/images/products/yon-voice.webp' },
      { number: '02', title: 'Toplantı Özetleri ve Görev Yönetimi', description: 'Toplantılar otomatik olarak transkribe edilir, eylem maddeleri tespit edilir ve ilgili kişilere görev olarak atanır. Manuel not alma ihtiyacı ortadan kalkar.', image: '/images/products/yon-meeting.webp' },
      { number: '03', title: '7/24 Erişilebilirlik ve Yüksek Güvenlik', description: 'Platform kesintisiz çalışır ve tüm veri işlemleri yüksek güvenlik standartları kapsamında yürütülür. Çok sektörlü kullanıma uygun esnek altyapısıyla her ölçekte kuruma entegre edilebilir.', image: '/images/products/yon-security.webp' },
    ],
    featured: false,
    color: 'bg-accent/8 text-accent-dark border-accent/15',
    dot: 'bg-accent',
    en: {
      ...
      features: [
        { number: '01', title: 'Voice and Text Command Understanding', description: 'Detects both voice and text commands in natural language through NLP. Everyday expressions like "Schedule a meeting tomorrow at 10" are instantly processed.', image: '/images/products/yon-voice.webp' },
        { number: '02', title: 'Meeting Summaries and Task Management', description: 'Meetings are automatically transcribed, action items are identified, and assigned as tasks to relevant people. The need for manual note-taking is eliminated.', image: '/images/products/yon-meeting.webp' },
        { number: '03', title: '24/7 Accessibility and High Security', description: 'The platform operates continuously and all data operations are conducted under high security standards. Integrable with any scale of organization through its flexible, multi-sector infrastructure.', image: '/images/products/yon-security.webp' },
      ],
      howItWorks: [
  ...
  },
  {
    ...
    heroImage: '/images/products/spiral-hero.webp',
    gallery: [
      '/images/products/spiral-hero.webp',
      '/images/products/tercumed-steps.webp',
      '/images/products/spiral-2.webp',
      '/images/products/spiral-hero.webp',
    ],
    features: [
      { number: '01', title: 'Patentli Hava Akışı Teknolojisi', description: "Kabinde ideal ve homojen hava geçişi oluşturan özel bant tipleriyle konveyör taşıma sistemi, ısı transferini hızlandırır. Gelişmiş yalıtım panelleriyle enerji tüketimi %30'a kadar azalır.", image: '/images/products/tercumed-steps.webp' },
      { number: '02', title: 'Modüler Tasarım', description: 'Projeye özel modüller kapasite ayarlamasına izin verir. Mevcut ekipmanı sökmeden yeni spiral katmanlar veya bant modülleri eklenerek kapasite dakikalar içinde ikiye katlanabilir.', image: '/images/products/spiral-2.webp' },
      { number: '03', title: 'Entegre CIP Sistemi ve Sertifikasyon', description: "Clean-in-Place sistemi temizlik sürelerini kısaltır, 3-A SSA ve CE standartlarına tam uyumluluk sağlar. 20+ yıllık deneyim ve 7/24 teknik destekle sistemin kesintisiz çalışması garanti altındadır.", image: '/images/products/spiral-hero.webp' },
    ],
    featured: false,
    color: 'bg-sky/8 text-sky border-sky/15',
    dot: 'bg-sky',
    en: {
      ...
      features: [
        { number: '01', title: 'Patented Airflow Technology', description: 'The conveyor system with special belt types creating ideal homogeneous airflow in the cabinet accelerates heat transfer. Energy consumption is reduced by up to 30% with advanced insulation panels.', image: '/images/products/tercumed-steps.webp' },
        { number: '02', title: 'Modular Design', description: 'Project-specific modules allow capacity adjustment. New spiral layers or belt modules can be added without disassembling existing equipment, doubling capacity within minutes.', image: '/images/products/spiral-2.webp' },
        { number: '03', title: 'Integrated CIP System & Certification', description: 'The Clean-in-Place system shortens cleaning times and ensures full compliance with 3-A SSA and CE standards. Uninterrupted operation is guaranteed with 20+ years of experience and 24/7 technical support.', image: '/images/products/spiral-hero.webp' },
      ],
      howItWorks: [
